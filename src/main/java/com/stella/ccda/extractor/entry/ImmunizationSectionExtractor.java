...
public class ImmunizationSectionExtractor implements CCDElementExtractor {
    ...
    @Override
    public String extract(Document document) throws XPathExpressionException, ParseException {
        final StringBuilder sbSql = new StringBuilder();
        LOG.info("----------------------------");
        LOG.info("Reading Immunization Section");

        final Node sectionNode = Utils.extractSectionByID(document, "//section[templateId/@root='"
    ...
    private String extractEntry(final Node entry) throws XPathExpressionException, ParseException {
        ...
        String sqlImmunization = "INSERT INTO records.\"Immunization\" (m2hid, name, datespreviouslygiven, nextdue, description, reporturl, lastenquirydate, timestamp, immunizationGroupId) "
        ...
        if (entry.getNodeType() == Node.ELEMENT_NODE) {
            ...
            sqlImmunization = String.format(sqlImmunization, m2hid, name, datesPreviouslyGiven, nextDue, description,
                    reportUrl, lastEnquiryDate, timeStamp, immunGroupId);
    ...
    private String getNameFromNode(final Node entry, final String nameRef) throws XPathExpressionException {
        ...
        XPathExpression nameXpathExp = Utils.getXPathExpression("../text/table/tbody/tr[@ID='" + nameRef
                + "']/td[1]/text()");
    ...
    private String getDatesPreviouslyGiven(final Node entry, final String nameRef) throws XPathExpressionException {
        ...
        XPathExpression datesPreviouslyXpathExp = Utils.getXPathExpression("../text/table/tbody/tr[@ID='" + nameRef
                + "']/td[2]/content");
    ...
    private String getNextDue(final Node entry, final String nameRef) throws XPathExpressionException {
        ...
        XPathExpression nextDueXpathExp = Utils.getXPathExpression("../text/table/tbody/tr[@ID='" + nameRef
                + "']/td[3]/text()");
